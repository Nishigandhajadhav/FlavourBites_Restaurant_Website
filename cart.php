                ...
                <tr>
                    <td>
                        <div class="product-item">
                            <a class="product-thumb" href="#"><img src="image/<?php echo $pro['img']; ?>" alt="Product"></a>
                            <div class="product-info">
                                <h4 class="product-title"><a href="#"><?php echo $pro['name'];?></a></h4><span><em>Orignal Prise:</em> <?php echo $pro['oprise'];?></span><span><em>Discounted:</em><?php echo ($pro['oprise']/100)*$pro['discount'];?></span>
                            </div>
                        </div>
                    </td>
                    <form  method="POST" enctype="multipart/form-data">
                    ...
                    <?php   $subtotal = $pro['oprise'] * $row['quantity'];
                            $discount = $pro['oprise'] * $row['quantity'] - (($pro['oprise']/100)*$pro['discount']) * $row['quantity'];
                            $final =  $pro['discount'] * $row['quantity'];?>
                    ...
                    <div class="modal fade" id="deleteModal_<?php echo $row['id'];?>"tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Are you sure want to delete this Details......? </p>
                                </div>
                                <div class="modal-footer">
                                    <form  method="POST" enctype="multipart/form-data">
                                        <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Close</button>
    ...
    <div class="shopping-cart-footer">
        ...
        <div class="column">
            ...
            <?php } else { ?>
                ...
                <p class="text-danger">Your cart is empty. Please add some Menus to checkout.</p>
            <?php } ?>
        </div>
    </div>
    </form>
